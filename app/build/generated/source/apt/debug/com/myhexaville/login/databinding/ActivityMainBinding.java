...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // views
    @NonNull
    public final com.myhexaville.login.views.renders.login.LoginButton button;
    @NonNull
    ...
    @NonNull
    public final com.myhexaville.login.views.renders.FlexibleFrameLayout wrapper;
    // variables
    // values
    // listeners
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.button = (com.myhexaville.login.views.renders.login.LoginButton) bindings[3];
        ...
        this.wrapper = (com.myhexaville.login.views.renders.FlexibleFrameLayout) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
